...
describe "Merchant by Items Sold API" do
  describe 'basic api call' do
    before :each do
      ...
      @invoice_item1 = create(:invoice_item, quantity: 10, item_id: @item1.id, invoice_id: @invoice1.id)
      @invoice_item2 = create(:invoice_item, quantity: 10, item_id: @item2.id, invoice_id: @invoice2.id)
      @invoice_item3 = create(:invoice_item, quantity: 10, item_id: @item3.id, invoice_id: @invoice3.id)
      @invoice_item4 = create(:invoice_item, quantity: 10, item_id: @item4.id, invoice_id: @invoice4.id)
      @invoice_item5 = create(:invoice_item, quantity: 10, item_id: @item5.id, invoice_id: @invoice5.id)
      @invoice_item6 = create(:invoice_item, quantity: 10, item_id: @item6.id, invoice_id: @invoice6.id)
      @invoice_item7 = create(:invoice_item, quantity: 10, item_id: @item7.id, invoice_id: @invoice7.id)
      @invoice_item8 = create(:invoice_item, quantity: 10, item_id: @item8.id, invoice_id: @invoice8.id)
      @invoice_item9 = create(:invoice_item, quantity: 10, item_id: @item9.id, invoice_id: @invoice9.id)
